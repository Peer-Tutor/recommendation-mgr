...
ENTRYPOINT ["java" ,"-cp","app:app/lib/*","com.peertutor.TutorMgr.RecMgrApplication"]

# to use for ci cd
# ENTRYPOINT ["java" ,"-cp","app:app/lib/*","com.peertutor.TutorMgr.RecMgrApplication", "-Dspring.profiles.active=docker"]
